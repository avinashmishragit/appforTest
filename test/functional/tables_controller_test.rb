...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { desc: @table.desc, table_child_id: @table.table_child_id, table_name: @table.table_name }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { desc: @table.desc, table_child_id: @table.table_child_id, table_name: @table.table_name }
    assert_redirected_to table_path(assigns(:table))
  end
